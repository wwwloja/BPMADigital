(() => {
  ...
  async function generateMobilePdf(opts={}){
    ...
    try{
      ...
      `;
      if(opts.wrapperId==='view-bo') style.textContent+=`
        #bpmaPdfStaging #view-bo .print-area{display:block!important;width:100%!important;min-width:0!important;height:auto!important;overflow:visible!important;background:#fff!important;border:0!important;padding:0!important}
        #bpmaPdfStaging #view-bo table.form{display:table!important;width:100%!important;table-layout:fixed!important;border-collapse:collapse!important;margin:0!important;box-shadow:none!important;border-radius:0!important;overflow:visible!important}
        #bpmaPdfStaging #view-bo table.form tbody{display:table-row-group!important}
        #bpmaPdfStaging #view-bo table.form tr{display:table-row!important;break-inside:auto!important}
        #bpmaPdfStaging #view-bo table.form td,#bpmaPdfStaging #view-bo table.form th{display:table-cell!important;width:auto!important;padding:2px 3px!important;border:1px solid #111!important;vertical-align:top!important;background:#fff!important;color:#000!important;font-size:9pt!important}
        #bpmaPdfStaging #view-bo .subcard{break-inside:auto!important;page-break-inside:auto!important;margin:0 0 3px!important;border:0!important;box-shadow:none!important}
        #bpmaPdfStaging #view-bo .print-render{display:block!important;white-space:pre-wrap!important;overflow-wrap:anywhere!important;word-break:break-word!important;color:#000!important;line-height:1.2!important;min-height:13px!important;font-size:9pt!important}
        #bpmaPdfStaging #view-bo input:not([type=checkbox]):not([type=radio]),#bpmaPdfStaging #view-bo select,#bpmaPdfStaging #view-bo textarea{display:none!important}
        #bpmaPdfStaging #view-bo .header-table td{height:60px!important;text-align:center!important;vertical-align:middle!important}
        #bpmaPdfStaging #view-bo .section-title{background:#e6e6e6!important;text-align:center!important;font-size:10pt!important}
      `;
      ...
      const options={
        ...
        pagebreak:{mode:opts.wrapperId==='view-bo'?[]:['css']}
  ...
  // páginas A4 diretamente no jsPDF. Os anexos entram após o RFA.
  function rfaMainChildren(){
    ...
    clone.querySelector('#annexPrintBefore')?.remove();
    clone.querySelector('#annexManager')?.remove();
    clone.querySelector('#annexBeforeManager')?.remove();
    ...
    return Array.from(clone.children).filter(el=>!el.matches('#annexPrintBefore,#annexPrintPages,#annexBeforeManager,#annexManager,.no-print,.print-actions'));
  }
  ...
  async function generateRfaMobilePdf(opts={}){
    ...
    try{
      ...
      // Campo inicial: cada arquivo ou página do PDF precede o RFA.
      const initialAnnexes=Array.from(document.querySelectorAll('#annexPrintBefore .annex-print-sheet'));
      for(const sheet of initialAnnexes){
      ...
      // Anexos ao final, um por página A4.
